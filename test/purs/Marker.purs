...
setterSpecs = do
  describe "Test Getters and Setters" do
    it "Can set a marker's position" do
      ...
      let
        set = setMarker G.setPosition
      testIso latLng set G.getPosition
    let
      setAnimation = setMarker G.setAnimation
    ...
    let
      setClickable = setMarker G.setClickable
    ...
    -- TODO: Cursor
    let
      setDraggable = setMarker G.setDraggable
